                      ...
                      <div class="col-lg-5">  
                        <div class="card">
                           <div class="card-body text-center" style="background: #212F3D; border-radius: 1.5%">
                              ...
                              <h3 class="text-center" style="font-weight: bold; color: white">Rp. <?=number_format($detail->biaya_paket, 0, ".", ".")?>,00</h3>
                             
                            </div>
                          </div>
                          <div class="card" style="background: #212F3D">
                            <div class="card-body" style="font-weight: bold; color: white"><h5>Kuota : {{$detail->stok}} Paket belajar</h5></div>
                          </div>
                        </div>
