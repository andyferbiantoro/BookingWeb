...
public function booking($id){//$id mengambil id paket
            ...
            $id_lembaga_periode = Paket::where('id',$id)->with('Datalembaga')->pluck('id_lembaga');//ambil id_lembaga dai tabel paket sesuai dengan lembaga yang dipilih


            $list_periode = PeriodeBooking::where('id_lembaga',$id_lembaga_periode)->orderBy('id','DESC')->get();
	    		return view('pemesan.booking',compact('bookingpaket','Pemesan','Datalembaga','list_periode'));
