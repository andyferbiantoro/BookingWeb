...
class TransaksiController extends Controller
{
	...
	public function notification(Request $request)
	{
        ...
        $validSignatureKey = hash("sha512", $notification->order_id . $notification->status_code . $notification->gross_amount . "SB-Mid-server-pJBkuU2Oz1Yojt-4gredw-H-");
		...
		//ambil data dari tabel booking berdasarkan kode_booking($Order_id)
		$booking = Booking::where('kode_booking',$orderId)->first();
		$paket = Paket::where('id',$booking->id_paket)->first();
